...
internal static class HtmlRenderer
{
    ...
    private static bool KeepsOwnElement(HtmlNode c) => c.Attr("id") != null || c.Attr("class") != null || c.Attr("data-pseudo") != null;
    ...
    /// <summary>List markers as text at the front of the li: disc/circle/square/decimal, none to skip.</summary>
    private static void AddMarker(HtmlNode li, HtmlNode list, Dictionary<string, string> css, int ordinal)
    {
        if (li.Attr("data-marker") != null) return;
        li.Attributes["data-marker"] = "1";
