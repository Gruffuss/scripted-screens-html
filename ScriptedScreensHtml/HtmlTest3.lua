...
--   scroll    a box with overflow: auto, longer than it is tall; wheel over it; a sticky header
...
<style>
  ...
  .log .head { position: sticky; top: 0; background: #24314A; color: var(--accent); font-size: 11px; text-transform: uppercase; z-index: 1; }
